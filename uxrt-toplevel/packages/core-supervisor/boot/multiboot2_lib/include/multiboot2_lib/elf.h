...
#ifndef _XIOS_COMMON_BOOT_ELF_H
#define	_XIOS_COMMON_BOOT_ELF_H 1
...
#define BOOTABLE_ELF_DATA ELFDATA2LSB
#elif __BYTE_ORDER == __BIG_ENDIAN
#define BOOTABLE_ELF_DATA ELFDATA2MSB
#else
#error No byte order defined
#endif

#define BOOTABLE_ELF32(h) \
	((h.e_ident[EI_MAG0] == ELFMAG0) & (h.e_ident[EI_MAG1] == ELFMAG1) \
		& (h.e_ident[EI_MAG2] == ELFMAG2) & (h.e_ident[EI_MAG3] == ELFMAG3) \
		& (h.e_ident[EI_CLASS] == ELFCLASS32) \
	    & (h.e_ident[EI_DATA] == BOOTABLE_ELF_DATA) \
		& (h.e_ident[EI_VERSION] == EV_CURRENT) & (h.e_type == ET_EXEC) \
		& (h.e_version == EV_CURRENT))

#define BOOTABLE_ELF64(h) \
	((h.e_ident[EI_MAG0] == ELFMAG0) & (h.e_ident[EI_MAG1] == ELFMAG1) \
		& (h.e_ident[EI_MAG2] == ELFMAG2) & (h.e_ident[EI_MAG3] == ELFMAG3) \

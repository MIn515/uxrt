...
typedef struct seL4_X86_mb_mmap {
    seL4_Uint32 size; // size of this struct in bytes
    seL4_Uint64 base_addr; // physical address of start of this region
    seL4_Uint64 length; // length of the region this struct represents in bytes
    seL4_Uint32 type; // memory type of region. Type 1 corresponds to RAM.
...
typedef struct seL4_BootInfo_mbi2 {
    seL4_BootInfoHeader header;
    seL4_Word mbi_vaddr;
    seL4_Word mbi_paddr;

} SEL4_PACKED seL4_BootInfo_MBI2;

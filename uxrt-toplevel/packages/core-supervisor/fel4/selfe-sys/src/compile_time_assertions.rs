...
const SEL4_GETMR: unsafe extern "C" fn(c_types::c_int) -> seL4_Word = seL4_GetMR;
const SEL4_SETMR: unsafe extern "C" fn(c_types::c_int, seL4_Word) = seL4_SetMR;
...
const SEL4_GETBADGE: unsafe extern "C" fn(c_types::c_int) -> seL4_Word = seL4_GetBadge;
const SEL4_GETCAP: unsafe extern "C" fn(c_types::c_int) -> seL4_CPtr = seL4_GetCap;
const SEL4_SETCAP: unsafe extern "C" fn(c_types::c_int, seL4_CPtr) = seL4_SetCap;
...
#[cfg(KernelIsMCS)]
const SEL4_RECV: unsafe extern "C" fn(seL4_CPtr, *mut seL4_Word, seL4_CPtr) -> seL4_MessageInfo = seL4_Recv;
#[cfg(not(KernelIsMCS))]
const SEL4_NBRECV: unsafe extern "C" fn(seL4_CPtr, *mut seL4_Word) -> seL4_MessageInfo =
    seL4_NBRecv;
#[cfg(KernelIsMCS)]
const SEL4_NBRECV: unsafe extern "C" fn(seL4_CPtr, *mut seL4_Word, seL4_CPtr) -> seL4_MessageInfo =
    seL4_NBRecv;
...
#[cfg(KernelIsMCS)]
const SEL4_WAIT: unsafe extern "C" fn(seL4_CPtr, *mut seL4_Word) -> seL4_MessageInfo = seL4_Wait;
...
mod kernel_printing_compile_time_assertions {
    use super::*;
    const DEBUG_PUT_CHAR: unsafe extern "C" fn(c: c_types::c_char) = seL4_DebugPutChar;
...
mod debug_build_compile_time_assertions {
    ...
    const DEBUG_NAME_THREAD: unsafe extern "C" fn(seL4_CPtr, *const c_types::c_char) =
